      ...
      <div class="main-body">
        ...
        <div class="medium-card">
          <b-card class="top">
            ...
            <b-card-body class="title">Paso 5 de 5</b-card-body>
            <div class="navigation">
              <router-link to="/add-client-4-2">
                <div><img src="../../assets/AddClient/LeftArrow.png"></div>
              </router-link>
              <div><a href="/add-client-4-2"><p class="text">Anterior</p></a></div>
              <div><a href="/add-client-5-1"><p class="text">Siguiente</p></a></div>
              <router-link to="/add-client-5-1">
                <div><img src="../../assets/AddClient/RightArrow.png"></div>
              </router-link>
            </div>
          </b-card>
          <b-card class="bottom">
            <div><h2 class="title">¿Cobraré servicios<br>
              de delivery?</h2></div>
            <div class="btn-container">
              <div style="display: inline-block"><b-button class="choice" to="/add-client-5-1">
