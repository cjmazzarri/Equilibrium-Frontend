      ...
      <div class="main-body">
        ...
        <div class="medium-card">
          <b-card class="top">
            ...
            <b-card-body class="title">Paso 5.3 de 5</b-card-body>
            <div class="navigation">
              <router-link to="/add-client-5-2">
                <div><img src="../../assets/AddClient/LeftArrow.png"></div>
              </router-link>
              <div><a href="/add-client-5-2"><p class="text">Anterior</p></a></div>
              <div><a href="/add-client-6"><p class="text">Siguiente</p></a></div>
              <router-link to="/add-client-6">
