      ...
      <div class="main-body">
        ...
        <div class="medium-card">
          <b-card class="top">
            ...
            <b-card-body class="title">Paso 3.3 de 5</b-card-body>
            <div class="navigation">
              <router-link to="/add-client-3-2">
                <div><img src="../../assets/AddClient/LeftArrow.png"></div>
              </router-link>
              <div><a href="/add-client-3-2"><p class="text">Anterior</p></a></div>
              <div><a href="/add-client-4"><p class="text">Siguiente</p></a></div>
